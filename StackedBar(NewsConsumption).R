...
ggplot(news_consumption_accuracy, aes(x = News_Frequency, y = Count, fill = Identification)) +
  ...
  labs(title = "Accuracy by News Consumption Frequency (Correct vs Incorrect)",
       x = "News Consumption Frequency", y = "Count") +
  theme_minimal() +
